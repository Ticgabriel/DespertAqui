...
| 🧭 Acompanhamento ao Vivo | 🌙 Modo Descanso (OLED) | ⏰ Alarmes e Rotinas |
|:---:|:---:|:---:|
| <img src="assets/screenshots/04-acompanhamento.png" width="260" alt="Acompanhamento"> | <img src="assets/screenshots/05-modo-descanso.png" width="260" alt="Modo Descanso"> | <img src="assets/screenshots/06-alarmes.png" width="260" alt="Alarmes Recorrentes"> |
| *Distância em tempo real e status do sinal GPS.* | *Visual minimalista escuro para cochilar em paz.* | *Agendamentos automáticos de segunda a sexta.* |
